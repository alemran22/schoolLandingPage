    ...
    <section className="bg-first-step-bg1 bg-no-repeat bg-cover bg-center  ">
      <section className="bg-first-step-bg2 bg-repeat-x bg-cover bg-center">
        <section className="bg-modified_blue/75">
          {/* for mobile */}
          <section className="bg-firstStepMobileBG lg:hidden flex flex-col items-center  space-y-8 py-12 px-4 ">
          ...
          {/* for desktop */}
          <main className="bg-firstStepGif bg-cover">
            <section className=" max-w-7xl mx-auto h-[532px] py-20 hidden lg:flex gap-5">
              {/* left section */}
